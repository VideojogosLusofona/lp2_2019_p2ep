<!--
Projeto de 2ª Época de Linguagens de Programação II 2019/2020 (c) by Nuno Fachada

Projeto de 2ª Época de Linguagens de Programação II 2019/2020 is licensed under a
...
# Projeto de 2ª Época de Linguagens de Programação II 2019/2020

## Descrição do projeto

Os alunos devem implementar o jogo *[18 Ghosts]* para dois jogadores, as
regras do qual estão disponíveis [aqui][regras].

O jogo deve ser implementado em consola (.NET Core) e em Unity. A lógica,
...
* **Não serão avaliados projetos que não cumpram os requisitos indicados na
  [Descrição do projeto](#descricao-do-projeto) ou que não funcionem.**
...
[18 Ghosts]:https://boardgamegeek.com/boardgame/70116/18-ghosts
...
[ia-simplexity]:https://github.com/VideojogosLusofona/ia_2019_board_game_ai
